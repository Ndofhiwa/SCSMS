    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="filter-bar">
                <a href="dashboard.jsp?filterStatus=ALL">
                    <button class="<%= filterStatus.equals("ALL") ? "active" : "" %>">All</button>
                </a>
                <a href="dashboard.jsp?filterStatus=PENDING">
                    <button class="<%= filterStatus.equals("PENDING") ? "active" : "" %>">Pending</button>
                </a>
                <a href="dashboard.jsp?filterStatus=IN_PROGRESS">
                    <button class="<%= filterStatus.equals("IN_PROGRESS") ? "active" : "" %>">In Progress</button>
                </a>
                <a href="dashboard.jsp?filterStatus=COMPLETED">
                    <button class="<%= filterStatus.equals("COMPLETED") ? "active" : "" %>">Completed</button>
                </a>
            </div>
